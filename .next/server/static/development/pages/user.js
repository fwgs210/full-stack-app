...
var LineButton = styled_components__WEBPACK_IMPORTED_MODULE_0___default.a.a.attrs({
  type: 'button'
})(_templateObject6());
  ...
  function ChangePassword() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changePassword", function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.post('/api/user/change-password', {
        userId: _this.state.loggedInAs,
        oldPassword: Object(_utils_globalFunc__WEBPACK_IMPORTED_MODULE_4__["stripSpaces"])(_this.state.currentPass),
...
/* harmony import */ var react_placeholder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react-placeholder */ "react-placeholder");
/* harmony import */ var react_placeholder__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react_placeholder__WEBPACK_IMPORTED_MODULE_4__);
...
function (_Component) {
  ...
  _createClass(ChatBox, [{
    ...
    value: function render() {
      ...
      if (this.loggedIn) {
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_placeholder__WEBPACK_IMPORTED_MODULE_4___default.a, {
          type: "text",
          rows: 10,
          ready: this.loaded,
          __source: {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["connect"])(mapStateToProps)(ChatBox));
...
var NewPostContainer = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.div(_templateObject());
var UserApp = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.section(_templateObject2());
...
function (_Component) {
  ...
  function Dashboard(props) {
    ...
    _this.token = props.user.token;
    _this.userRole = props.user.userRole;
    _this.users = props.admin.users;
    _this.loggedInAs = props.user.loggedInAs;
    return _this;
  }
